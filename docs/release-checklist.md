...
12. Ensure both project versions match, then publish a GitHub Release whose tag is exactly `v<version>` (for example, `v0.1.0-alpha.1`). The release workflow validates, tests, packs, audits, and publishes both packages.
